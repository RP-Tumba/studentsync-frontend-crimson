                ...
                <div className="Fname"> <p>First Name</p><input type="text" name="first_name"  value={student.first_name} onChange={handleInput} required/></div>
                 <div className="Fname"> <p>Last Name</p><input type="text" name="last_name"  value={student.last_name} onChange={handleInput} required/></div>
                  ...
                  <div className="studentId"><p>Student Id</p><input type="text" name="student_id"  value={student.student_id} onChange={handleInput} required/></div>
                   ...
                   <div className="last3">
                     <div className="email"><p>Email</p> <input type="email" name="email" value={student.email} onChange={handleInput} required/></div><p></p>
                   <div className="contactNumber"> <p>Contact Number</p><input type="number" name="contact_number" value={student.contact_number} onChange={handleInput}required /></div>
                    <div className="enrollmentDate"> <p>Enrollment Date</p> <input type="date" name="enrollment_date"  value={student.enrollment_date} onChange={handleInput} required/></div>
               </div>
               <br />
